              ...
              <div className="card">
                <div className="search-bar">
                  <div className="search-box">
                    <input type="text" id="destination" name="destination" className="inp" placeholder="Search your destination here" />
                  </div>
                  <div className="date-box">
                    {/* <input type="text" id="date" name="date"className="inp" placeholder="Select a date" /> */}
                    <DatePicker selected={startDate} onChange={(date) => setStartDate(date)} className="inp" isClearable showYearDropdown scrollableYearDropdown />
                  </div>
